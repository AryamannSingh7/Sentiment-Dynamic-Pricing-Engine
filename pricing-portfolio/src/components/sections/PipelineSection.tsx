          ...
          {NODES.map((node, i) => (
            <div key={node.label} className="flex flex-col md:flex-row items-center">
              ...
              <motion.div
                ...
                className="panel p-4 flex flex-col items-center text-center w-36 flex-shrink-0 hover:shadow-lift transition-all duration-200"
              >
              ...
              {i < NODES.length - 1 && (
                ...
                >
                  ...
                  >
                    <path d="M 2 8 L 24 8" stroke="var(--accent)" strokeWidth="1.5" strokeDasharray="4 2" />
                    <path d="M 22 5 L 28 8 L 22 11" fill="none" stroke="var(--accent)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                  <svg
                    className="block md:hidden my-1"
                    width="16" height="24" viewBox="0 0 16 24"
                  >
                    <path d="M 8 2 L 8 18" stroke="var(--accent)" strokeWidth="1.5" strokeDasharray="4 2" />
                    <path d="M 5 16 L 8 22 L 11 16" fill="none" stroke="var(--accent)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </motion.div>
              )}
            </div>
